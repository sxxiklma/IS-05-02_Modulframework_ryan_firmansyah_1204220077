...
<head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')('resources/sass/myweb.scss'); ?>
        ...
        <div class="container py-5 px-4">
            <div class="container text-center">
                <div class="row">
                    ...
                    <div class="col">
                        <img class="img-thumbnail" src="<?php echo e(Vite::asset('resources/images/2.jpg')); ?>"
                            alt="image">
            ...
            <div class="bg-light mt-5" id="bagian3">
                <div class="container py-5 px-4">
                    ...
                    <div class="card-group">
                        <div class="card">
                            <img class="img-thumbnail" src="<?php echo e(Vite::asset('resources/images/1.jpg')); ?>"
                                alt="image">
                            <div class="card-body">
                        ...
                        <div class="card">
                            <img class="img-thumbnail" src="<?php echo e(Vite::asset('resources/images/4.jpg')); ?>"
                                alt="image">
                            <div class="card-body">
                        ...
                        <div class="card">
                            <img class="img-thumbnail" src="<?php echo e(Vite::asset('resources/images/5.jpg')); ?>"
                                alt="image">
                            <div class="card-body">
                        ...
                        <div class="card">
                            <img class="img-thumbnail" src="<?php echo e(Vite::asset('resources/images/6.jpg')); ?>"
                                alt="image">
                            <div class="card-body">
...
<?php /**PATH C:\xampp\htdocs\Pemograman framework\framework\resources\views/myweb.blade.php ENDPATH**/ ?>